...
<body>
    <div class="container">
        ...
        <div class="jumbotron">
            ...
            <p class="lead text-center text-success leadTarget">Bieżący rok</p>
            <hr class="my-4">
                            ...
                            $year = $current_date->format('Y');                 
                                ...
                                foreach($result_sum_of_incomes as $year_incomes)
                                {
                                    ...
                                    $result_details_of_incomes = $query_select_incomes_details->fetchAll();
                                     ...
                                     echo '<div class="card-header">'.$year_incomes[0].': '.$year_incomes[1].'zł'.'</div>';
                        ...
                        <?php 
                                ...
                                foreach($result_sum_of_expenses as $year_expenses)
                                {
                                    ...
                                    $result_details_of_expenses = $query_select_expenses_details->fetchAll();
                                     ...
                                     echo '<div class="card-header">'.$year_expenses[0].': '.$year_expenses[1].'zł'.'</div>';

...
<body>
    <div class="container">
        ...
        <div class="jumbotron">
            ...
            <p class="lead text-center text-success leadTarget">Bieżący miesiąc</p>
            <hr class="my-4">
            <div class="d-flex justify-content-center">
                <img src="img/logo.png" class="header__logo img-fluid" alt="logo aplikacji">
            </div>
            <?php
                        if(isset($_SESSION['e_balance_date']))
                        {
                            echo'<div class="text-danger">'.$_SESSION['e_balance_date'].'</div>';
                            unset($_SESSION['e_balance_date']);
                        }
                        ?>
